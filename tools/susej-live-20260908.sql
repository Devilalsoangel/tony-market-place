...
ALTER TABLE public."AddressBookEntry" OWNER TO postgres;
...
ALTER TABLE public."AuctionBid" OWNER TO postgres;
...
ALTER TABLE public."CommissionSetting" OWNER TO postgres;
...
ALTER TABLE public."FeaturedPost" OWNER TO postgres;
...
ALTER TABLE public."FoodHubItem" OWNER TO postgres;
...
ALTER TABLE public."HotDeal" OWNER TO postgres;
...
ALTER TABLE public."LiveStream" OWNER TO postgres;
...
ALTER TABLE public."LoyaltyUser" OWNER TO postgres;
...
ALTER TABLE public."NotificationHistoryItem" OWNER TO postgres;
...
ALTER TABLE public."PromotionPurchase" OWNER TO postgres;
...
ALTER TABLE public."ReportedComment" OWNER TO postgres;
...
ALTER TABLE public."ReportedMessage" OWNER TO postgres;
...
ALTER TABLE public."ReportedProduct" OWNER TO postgres;
...
ALTER TABLE public."ReportedUser" OWNER TO postgres;
...
ALTER TABLE public."RevenueMetrics" OWNER TO postgres;
...
ALTER TABLE public."StorefrontBanner" OWNER TO postgres;
...
ALTER TABLE public."TopSeller" OWNER TO postgres;
