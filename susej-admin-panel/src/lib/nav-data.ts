...
export const MODULES: NavModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Auctions", href: "/dashboard/auctions", icon: Gavel, badge: 6 },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Seller Verification", href: "/dashboard/sellers", icon: UserCheck, badge: 12 },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Reviews & Ratings", href: "/dashboard/reviews", icon: Star, badge: 7 },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Promotions & Ads", href: "/dashboard/promotions", icon: Banknote, badge: 3 },
      { label: "Commission & Fees", href: "/dashboard/commission", icon: Percent },
      { label: "Wallet", href: "/dashboard/wallet", icon: Wallet },
      { label: "Refunds", href: "/dashboard/refunds", icon: RotateCcw, badge: 4 },
      { label: "Disputes", href: "/dashboard/disputes", icon: Scale, badge: 3 },
  ...
  },
  {
    ...
    icon: Headphones,
    items: [
      { label: "Support Tickets", href: "/dashboard/support", icon: Headphones, badge: 8 },
      { label: "Notifications", href: "/dashboard/notifications", icon: Bell },
      { label: "Reports Queue", href: "/dashboard/reports-queue", icon: Flag, badge: 5 },
    ],
  },
  {
    id: "analytics",
